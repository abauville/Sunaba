...
Grid.xmin = HFac* -1.25e3*LWRatio
Grid.xmax = HFac*  0.0e3
Grid.ymin = HFac* 0.0e3
Grid.ymax = HFac* 1.25e3
Grid.nxC = round(1/1*(96)*LWRatio) #round( RefinementFac*(Grid.ymax-Grid.ymin)/ CompactionLength)
...
ThickWeak = .025e3*HFac
Hweak = Hbase


Geometry["%05d_line" % i] = Input.Geom_Line(SedPhase,slope,Hsed - slope*W,"y","<",Grid.xmin,Grid.xmax)
#i+=1
#Geometry["%05d_line" % i] = Input.Geom_Line(SedPhase,tan(15.0/180.0*pi),Hsed,"y","<",Grid.xmin+W*.8,Grid.xmax)

# Weak Layer
i+=1
Geometry["%05d_line" % i] = Input.Geom_Line(WeakPhase,slope,Hweak +  ThickWeak - slope*W,"y","<",Grid.xmin+W*.1,Grid.xmin+Lweak)
i+=1
Geometry["%05d_line" % i] = Input.Geom_Line(SedPhase,slope,Hweak - slope*W,"y","<",Grid.xmin+W*.1,Grid.xmin+Lweak)


# Weak Layer
i+=1
Geometry["%05d_line" % i] = Input.Geom_Line(WeakPhase,slope,0.0+ThickWeak,"y","<",Grid.xmin,Grid.xmin+W*.4)
...
#Geometry["%05d_sine" % i] = Input.Geom_Sine(BasementPhase,Hbase - slope*W,0*0.25*Hbase,pi/16,Wseamount*2/5,"y","<",Grid.xmin+W*.6,Grid.xmax)
Geometry["%05d_sine" % i] = Input.Geom_Sine(BasementPhase,Hbase - slope*W,0*0.25*Hbase,pi/16,Wseamount*0.20,"y","<",Grid.xmin+W*.1,Grid.xmax)
#i+=1
#Geometry["%05d_sine" % i] = Input.Geom_Sine(BasementPhase,Hbase - slope*W,0*0.25*Hbase,pi+pi/16,Wseamount*2/5,"y","<",Grid.xmin+W*.5,Grid.xmax)


BCStokes.Sandbox_TopSeg00 = Hbase + ThickWeak + 0.0*Hbase
BCStokes.Sandbox_TopSeg01 = Hbase + ThickWeak + 0.0*Hbase
...
xWeak = Grid.xmin  + .5*(Grid.xmax-Grid.xmin)
Lweak = 1.*(Grid.xmax-Grid.xmin)
...
# Weak Layer
i+=1
Geometry["%05d_line" % i] = Input.Geom_Line(WeakPhase,slope,Hweak +  ThickWeak - slope*W,"y","<",xWeak,xWeak+Lweak)
i+=1
Geometry["%05d_line" % i] = Input.Geom_Line(SedPhase,slope,Hweak - slope*W,"y","<",xWeak,xWeak+Lweak)


# Weak Layer
i+=1
Geometry["%05d_line" % i] = Input.Geom_Line(WeakPhase,slope,0.0+ThickWeak,"y","<",Grid.xmin,Grid.xmax)
...
#Geometry["%05d_sine" % i] = Input.Geom_Sine(BasementPhase,Hbase - slope*W,3*Hbase,0,Wseamount*2,"y","<",xseamount-Wseamount/2,xseamount+Wseamount/2)
#Geometry["%05d_sine" % i] = Input.Geom_Sine(BasementPhase,Hbase - slope*W,0*0.25*Hbase,pi/16,Wseamount*2/5,"y","<",Grid.xmin+W*.6,Grid.xmax)
Geometry["%05d_sine" % i] = Input.Geom_Sine(BasementPhase,Hbase - slope*W,0*0.25*Hbase,pi/16,Wseamount*0.20,"y","<",xWeak,xWeak+Lweak)
#i+=1
#Geometry["%05d_sine" % i] = Input.Geom_Sine(BasementPhase,Hbase - slope*W,0*0.25*Hbase,pi+pi/16,Wseamount*2/5,"y","<",Grid.xmin+W*.5,Grid.xmax)


BCStokes.Sandbox_TopSeg00 = 1*Hbase + ThickWeak + 0.0*Hbase
BCStokes.Sandbox_TopSeg01 = 1*Hbase + ThickWeak + 0.0*Hbase
...
Visu.outputFolder = "/Users/abauville/GoogleDrive/Output_Sandbox_Step/"
