...
WeakLayer.cohesion = 35e6
Sediment.cohesion  = 35e6
Basement.cohesion  = 35e6
...
Grid.xmin = HFac* -1.35e3*LWRatio/2
Grid.xmax = HFac*  1.35e3*LWRatio/2
Grid.ymin = HFac* 0.0e3
Grid.ymax = HFac* 1.35e3
