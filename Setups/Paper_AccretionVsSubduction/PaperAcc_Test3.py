...
#baseFolder = "/Users/abauville/Output/Paper_AccretionVsSubduction/RepTest/01_Back_HFac%.0f_G%.0e_CWeak_C%.f/" % (HFac,Sediment.G,Sediment.cohesion/MPa)

baseFolder = "/Users/abauville/GoogleDrive/Output/01_Back_HFac%.0f_G%.0e_CWeak_C%.f/" % (HFac,Sediment.G,Sediment.cohesion/MPa)
