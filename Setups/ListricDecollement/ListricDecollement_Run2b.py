    ...
    for cohesionWeakFac in cohesionWeakFac_list:
        for Lambda in Lambda_list:
            for Hc_nd in Hc_nd_list:
                ...
                ###              Output
                ### =====================================
                postBaseFolder = "ListricDecollement/Output_Test_Dilation2b/Lambda%02d_Hc%03d_PfW%02d_CW%02d_GFac%03d/" % (Lambda*100, Hc_nd*100, PfWeakFac*100, cohesionWeakFac*100, maxElasticStrain*100)
