...
for PfWeakFac in PfWeakFac_list:
    ...
    for Lambda in Lambda_list:
        ...
        for Hc_nd in Hc_nd_list:
            ...
            alpha = Hc_nd * (1.0+0.5*Hc_nd) # empirical
            ## ========================================
...
#                    alpha = 5.0*np.pi/180.0
            ...
            ###              Output
            ### =====================================
            postBaseFolder = "ListricDecollement/Output_Test_Dilation4_noDilation/Lambda%02d_Hc%03d_PfW%02d_CW%02d_GFac%03d/" % (Lambda*100, Hc_nd*100, PfWeakFac*100, cohesionWeakFac*100, maxElasticStrain*100)
