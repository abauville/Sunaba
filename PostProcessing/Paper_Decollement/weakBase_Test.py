...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 19 15:04:47 2018
...
for iC in range(nC):
    for iL in range(nL):
        superDirList.append("Weak%02d/Lambda60/Lambda_b_Fac%02d" % (chi_list[iC], Lambda_list[iL]))
