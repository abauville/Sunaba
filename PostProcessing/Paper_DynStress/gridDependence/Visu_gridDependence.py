...
#        ResFac = float
        ...
        jump = int(nSteps/100)
        print("iSim = %i, nSteps = %i, jump = %i, ResFac = %i, iyCell = %i" % (iSim,nSteps, jump, ResFac, iyCell))
#        for i in range(0,nSteps,jump):
#            outFolder = "Out_%05d" % i
#            # Set file
#            # =====================
#            #outFolder = "Out_00009"
...
plt.legend(superDirList)

#for iSim in range(nSim-2,nSim-1):
...
plt.plot([0,2],np.array([Sy_back_C0, Sy_back_C0])/stressUnit)
