...
# Set file
# =====================
rootFolder = "/Users/abauville/StokesFD_Output/FaultAngle_Systematics/"
simFolder  = "HFac10_SA10_C1000000_FA16/"
inFolder  = "Input/"
outFolder = "Out_00000/"
...
for thisHFac in Syst_HFac:
    ...
    for thisCohesion in Syst_cohesion:
        plt.clf()
        plt.axis('equal')
        print("\nHFac: " + str(thisHFac) + ", C: " + str(thisCohesion) )
        ...
        plt.title( "Hsed = " + str(thisHFac) + " km" + ", Cohesion = " + str(thisCohesion/1e6) + " MPa")
