...
# Set file
# =====================
rootFolder = "/Users/abauville/StokesFD_Output/FaultAngle_Systematics_Batch02/"
...
for thisHSed in Syst_HSed:
    ...
    for thisCohesion in Syst_cohesion:
        ...
        for thisSurfaceAngle in Syst_surfaceAngleAngle:
            ...
            for thisFrictionAngle in Syst_frictionAngle:
                ...
                try:
                    ...
                    data = np.ma.masked_array(data, yv > (Hsed_nondim+tan(+thisSurfaceAngle*degree)*xv)) # Hide the air
        ...
        plt.savefig("Batch02/" + "HSed" + str(round(thisHSed)) + "_C" + str(round(thisCohesion)) + ".png", dpi=500)
